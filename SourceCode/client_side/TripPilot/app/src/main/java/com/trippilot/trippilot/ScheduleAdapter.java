        ...
        ScheduleContentAdapter adapter = null;
            if (type == 1) { //보기 모드 일때
                ...
                holder.add_content_btn.setOnClickListener(new Button.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        final AddDialog dialog = new AddDialog(type);
...
class AddDialog extends DialogFragment implements DataAddListener,DeleteContentListener{
    int type;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final SearchedLocationListView locFragment = new SearchedLocationListView(2,this);
